...
int connection_souris_3D();
int capture_mouvement();
int fd;
char *fname =NULL;
float x_trans;
float y_trans;
...
int connection_souris_3D()
{
	printf("Je suis le test de connection\n");
	int i =0;
	char *fname =NULL;
	struct input_id ID;
...
int capture_mouvement()
{
printf("Je suis dans la fonction de capture des mvt\n");
fd = open(fname, O_RDWR | O_NONBLOCK);
