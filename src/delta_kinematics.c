...
*/
DELTA_KINEMATICS_API int pointValid(struct point p)
{
...
*/
DELTA_KINEMATICS_API void getAngles(double* angles, struct point p)
{
...
*/
DELTA_KINEMATICS_API void lookupAngles(double inverseTable[X_TABLE_DIM][Y_TABLE_DIM][Z_TABLE_DIM][3],
...
*/
DELTA_KINEMATICS_API void printAngles(char indicator[], double angles[3])
{
